...
docker run --rm -v "$PWD":/usr/gopath/src/github.com/nstehr/bobcaygeon -w /usr/gopath/src/github.com/nstehr/bobcaygeon golang:1.12-stretch ./build-frontend-binary.sh